...
namespace DinosaurPark
{
    ...
    class Program
    {
        static List<Dinosaur> Dino = new List<Dinosaur>()
    {
      new Dinosaur()
      {
        Name = "Triceratops",
...
6) Quit        Exit the program");
        ...
        static void ViewDino()
        {
            Console.Clear();
            Console.WriteLine("------------------------\n~~.*.VIEW ALL DINO.*.~~\n------------------------\n");
            foreach (var dino in Dino)
            {
        ...
        static void RemoveDino()
        {
            ...
            var dinoRemoved = Dino.RemoveAll(dino => dino.Name == dinoNameToRemove);
            Console.WriteLine($"Removed {dinoRemoved} dino(s) named {dinoNameToRemove}.");
            WaitForKeyPress();
        }
        ...
        static void TransferDino()
        {
            ...
            Dino.Find(dino => dino.Name == dinoNameToTransfer).EnclosureNumber = exhibittotransferto;
            WaitForKeyPress();
        ...
        static void ParkSummary()
        {
            ...
            var herbivores = Dino.Where(dino => dino.DietType == "Herbivore");
            var carnivores = Dino.Where(dino => dino.DietType == "Carnivore");
